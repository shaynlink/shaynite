...
import LoopText from '@/components/animations/LoopText';
import FutureAnimation from '@/components/animations/FutureAnimation';
      ...
      <div className={styles.container}>
        <div className={styles.hero}>
          ...
          <div className={styles.heroShortDescription}>
            ...
            <p>Actually living in bordeaux, france student to openclassrooms and ynov. I have many years of experiences in web development on self-taught.</p>
          </div>
        </div>
      ...
      <div className={styles.partTwoContainer}>
        <div className={styles.heroPresentation}>
          <div className={styles.meDescription}>
            ...
            <p>I followed the OpenClassrooms Web Developer formation for studies the fundamentals of the job</p>
          </div>
        ...
        <div className={styles.someInformationLoop}>
          <LoopText text="some informations about me" repeat={3} />
        </div>
        ...
        <div className={styles.unifiedCard}>
          <div className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <p>I create Single page or Complexe website serverless</p>
            </div>
